...
web_patterns = [
    ...
    path("admin-panel/ai-upload-model/", views_web.AdminModelUploadView.as_view(), name="admin_ai_upload_model"),
    path("admin-panel/ai-export/", views_web.AdminAIExportView.as_view(), name="admin_ai_export"),
